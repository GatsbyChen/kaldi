...
# WER on(fglarge)        8.73      8.71
# WER on(tglarge)        9.22      9.05
# WER on(tgmed)         11.24     11.09
# WER on(tgsmall)       12.29     12.13
# WER on test(fglarge)             3.88      3.80
# WER on test(tglarge)             4.05      3.89
# WER on test(tgmed)               4.86      4.72
# WER on test(tgsmall)             5.30      5.19
# WER on(fglarge)       9.09      8.76
# WER on(tglarge)       9.54      9.19
# WER on(tgmed)        11.65     11.22
# WER on(tgsmall)      12.77     12.24
...
# WER on(fglarge)        8.63      8.66
# WER on(tglarge)        9.04      9.11
# WER on(tgmed)         11.03     11.21
# WER on(tgsmall)       12.21     12.26
# WER on test(fglarge)             3.79      3.77
# WER on test(tglarge)             3.92      3.96
# WER on test(tgmed)               4.80      4.79
# WER on test(tgsmall)             5.34      5.31
# WER on(fglarge)       8.94      8.94
# WER on(tglarge)       9.35      9.28
# WER on(tgmed)        11.32     11.28
# WER on(tgsmall)      12.43     12.39
...
# WER on(fglarge)        8.73      9.10      8.61      8.49      8.78      8.63
# WER on(tglarge)        9.22      9.46      9.11      8.92      9.23      9.04
# WER on(tgmed)         11.24     11.33     11.23     10.91     11.10     11.03
# WER on(tgsmall)       12.29     12.58     12.23     12.07     12.33     12.21
...
# WER on(fglarge)       9.09      9.02      9.05      8.88      9.02      8.94
# WER on(tglarge)       9.54      9.58      9.47      9.20      9.42      9.35
# WER on(tgmed)        11.65     11.63     11.35     11.28     11.46     11.32
# WER on(tgsmall)      12.77     12.69     12.51     12.38     12.60     12.43
...
# WER on(fglarge)       10.05      8.76
# WER on(tglarge)       10.80      9.26
# WER on(tgmed)         13.07     11.21
# WER on(tgsmall)       14.46     12.47
# WER on test(fglarge)             4.20      3.87
# WER on test(tglarge)             4.28      4.08
# WER on test(tgmed)               5.31      4.80
# WER on test(tgsmall)             5.97      5.25
# WER on(fglarge)      10.44      8.95
# WER on(tglarge)      11.05      9.41
# WER on(tgmed)        13.36     11.52
# WER on(tgsmall)      14.90     12.66
