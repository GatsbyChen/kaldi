...
stage=1
train_set=train_clean_460_cleaned    # you might set this to e.g. train_960
gmm=tri5b_cleaned         # This specifies a GMM-dir from the features of the type you're training the system on;
