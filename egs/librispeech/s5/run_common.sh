...
if [ $stage -le 2 ]; then
  ...
  for part in dev-clean dev-rvb-GSound-noisy dev-rvb-GSound-quiet dev-rvb-ISM-noisy \
  dev-rvb-ISM-quiet dev-rvb-Real-noisy dev-rvb-Real-quiet test-clean test-rvb-Real-noisy \
  test-rvb-Real-quiet train-clean-100 train-rvb-100-GSound-noisy train-rvb-100-GSound-quiet \
  train-rvb-100-ISM-noisy train-rvb-100-ISM-quiet train-rvb-100-Real-noisy train-rvb-100-Real-quiet; do
